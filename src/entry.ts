...
export default async function init(
  ...
  let arr = new Float32Array(
    [0.44373084494754944, 0.012341715444441181, 0.07892681580529581, 0.16983717354013406, 0.559106625669447, 
      0.09920468528804882, 0.9425709791902743, 0.9632256863827882, 0.48785917694153547, 0.727832145515513 ]
    )
  ...
  // const sumShader = new Ops.UnsortedSegmentSum2DShader(M, N, K);
  // await sumShader.setup(device, inputBuffer, segmentIdsBuffer, outputBuffer);
